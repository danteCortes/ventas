...
<a href="{{url('venta')}}" class="btn btn-primary">
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
    <div class="table-responsive">
      <table class="table table-condensed table-hover table-bordered" id="tblVentas">
        <thead>
          <tr style="background-color:#385a94; color:#FFF;">
            <th data-column-id="recibo" data-order="desc">RECIBO</th>
            <th data-column-id="proveedor">CLIENTE</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#31b0d5; color:#fff;">
        ...
        <h4 class="modal-title" id="myModalLabel">DATOS DE LA VENTA</h4>
      </div>
