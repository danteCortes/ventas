...
$prestamos = \App\Prestamo::where('cierre_id', '=', $cierre->id)->whereNull('devuelto')->where('direccion', 0)->get();
...
<table class="table table-condensed" id="tblPrestamosHechos">
  <tr>
    <th colspan="2" style="text-align:center; border-top:rgba(255, 255, 255, 0);">PRESTAMOS DE ENTRADA</th>
  </tr>
