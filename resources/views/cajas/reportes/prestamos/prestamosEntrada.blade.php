...
$prestamos = \App\Prestamo::where('cierre_id', '=', $cierre->id)->where('direccion', 0)->get();
...
<table class="table table-condensed" id="tblPrestamosHechos" style="margin-bottom:0px;">
  <tr>
    <th colspan="2" style="text-align:center; border-top:rgba(255, 255, 255, 0);">
      <p class="text-center" style="font-size: 12px; margin-bottom:1px;">PRESTAMOS DE ENTRADA</p></th>
  </tr>
