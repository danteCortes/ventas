<div class="modal fade" id="editarIngreso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      {{Form::open(['id'=>'frmEditarIngreso', 'method'=>'put'])}}
      {{ csrf_field() }}
      <div class="modal-header" style="background-color:#385a94; color:#fff;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">MODIFICAR INGRESO</h4>
      </div>
      <div class="modal-body" style="background-color:#e69c2d">
        <div class="panel" style="background-color:#bd7406">
          <div class="panel-body">
            <div class="form-group">
              <input type="text" class="form-control moneda input-sm" placeholder="MONTO *" name="monto" id="monto_ingreso"
                required>
            </div>
            <div class="form-group">
              <textarea name="descripcion" rows="4" cols="80" class="form-control mayuscula" required placeholder="DESCRIPCIÓN"
                id="descripcion_ingreso"></textarea>
            </div>
          </div>
        </div>
      </div>
