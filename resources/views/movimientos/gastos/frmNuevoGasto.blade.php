<div class="modal fade" id="frmNuevoGasto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      {{Form::open(['url'=>'movimiento/gasto', 'id'=>'frmNuevoGasto'])}}
      {{ csrf_field() }}
      ...
      <div class="modal-body" style="background-color:#e69c2d">
        <div class="panel" style="background-color:#bd7406">
          <div class="panel-body">
            ...
            <div class="form-group">
              <textarea name="descripcion" rows="4" cols="80" class="form-control mayuscula" required placeholder="DESCRIPCIÓN"></textarea>
            </div>
          </div>
        </div>
      </div>
