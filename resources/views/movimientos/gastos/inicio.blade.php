...
@section('contenido')
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="table-responsive">
            <table class="table table-hover table-condensed table-bordered" id="tblGastos">
              <thead>
                <tr>
  ...
  @include('movimientos.gastos.frmEditarGasto')
  @include('movimientos.gastos.frmEliminarGasto')
@stop

@section('scripts')
  {{Html::script('bootgrid/jquery.bootgrid.min.js')}}
  {{Html::script('assets/js/jquery.printarea.js')}}
  @include('movimientos.gastos.scripts')
@stop
